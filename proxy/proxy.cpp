...
void sethosts() {
    try
    {
        ...
        std::string postBody = "version=5.01&platform=0&protocol=211";
...
#endif
    init_discord();
    update_rpc("Not In Game.");
    std::cout << R"(                                                                                                        
 _    ___________ __  _____    __       ____  ____  ____ _  ____  __
| |  / /  _/ ___// / / /   |  / /      / __ \/ __ \/ __ \ |/ /\ \/ /
| | / // / \__ \/ / / / /| | / /      / /_/ / /_/ / / / /   /  \  / 
| |/ // / ___/ / /_/ / ___ |/ /___   / ____/ _, _/ /_/ /   |   / /  
|___/___//____/\____/_/  |_/_____/  /_/   /_/ |_|\____/_/|_|  /_/   
                                                                                                                                                                                             
| VISUAL PROXY | By Vetua._. | DC SERVER: https://discord.gg/KsAfTk2JTu |
)" << '\n';
    try {
        char* pValue;
        size_t len;
        errno_t err = _dupenv_s(&pValue, &len, "LOCALAPPDATA");
        string filePath = (string)pValue + "\\Growtopia\\cache\\items.dat";
        g_server->m_world.itemDataContainer.LoadItemData(filePath);
    }
    catch (exception err) {
        cout << err.what() << endl;
    }
